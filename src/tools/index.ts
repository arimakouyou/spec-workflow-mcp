...
import { setupClaudeSkillsTool, setupClaudeSkillsHandler } from './setup-claude-skills.js';
  ...
  try {
    switch (name) {
      ...
      case 'log-implementation':
        ...
        break;
      case 'setup-claude-skills':
        response = await setupClaudeSkillsHandler(args, context);
        break;
      default:
