---
name: spec-implement
description: "スペック駆動開発の Phase 5: 承認済み tasks.md のタスクを TDD(Red-Green-Refactor)で実装する。4つのスペックドキュメントがすべて存在する場合のみ使用。トリガー: implement task, start coding, work on task 3, implement spec X, continue implementation, /spec-implement。"
---
