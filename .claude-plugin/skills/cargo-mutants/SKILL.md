...
## Mutation Score Threshold (P3-08/P3-11)

Defines the minimum mutation score thresholds. Falling below a threshold indicates insufficient quality.
...
The following step can be added to the weekly CI generated by `/setup-ci --with-scheduled`:
...
The threshold check is performed in the weekly Issue creation step.
