---
name: spec-tasks
description: "スペック駆動開発の Phase 4: 承認済み設計をアトミックな実装タスクに分解する。テスト設計の承認後に使用。トリガー: create tasks, break down into tasks, implementation plan, task breakdown for X, tasks.md作成リクエスト。"
---
