...
description: "スペック駆動開発の Phase 3: UT/IT/E2E テスト仕様を定義するテスト設計ドキュメントを作成する。設計の承認後に使用。トリガー: create test design, test specification, define test plan for X, test-design.md作成リクエスト。"
---
