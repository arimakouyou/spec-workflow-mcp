...
|--------|-------------|---------|
| `--help` | Show comprehensive usage information | `npx -y @arimakouyou/spec-workflow-mcp@latest --help` |
| `--dashboard` | Run dashboard-only mode (default port: 5000) | `npx -y @arimakouyou/spec-workflow-mcp@latest --dashboard` |
| `--port <number>` | Specify custom dashboard port (1024-65535) | `npx -y @arimakouyou/spec-workflow-mcp@latest --dashboard --port 8080` |
| `--no-open` | Don't auto-open browser when starting dashboard | `npx -y @arimakouyou/spec-workflow-mcp@latest --dashboard --no-open` |
| `--no-shared-worktree-specs` | Disable shared `.spec-workflow` in git worktrees (use workspace-local instead) | `npx -y @arimakouyou/spec-workflow-mcp@latest ~/worktree --no-shared-worktree-specs` |
...
SPEC_WORKFLOW_SHARED_ROOT=$(pwd) npx -y @arimakouyou/spec-workflow-mcp@latest .

# Force a specific shared location
SPEC_WORKFLOW_SHARED_ROOT=/path/to/shared/specs npx -y @arimakouyou/spec-workflow-mcp@latest ~/my-worktree
```
...
```bash
# Main repo
npx -y @arimakouyou/spec-workflow-mcp@latest ~/myproject
# Dashboard shows: "myproject"

# Worktree
npx -y @arimakouyou/spec-workflow-mcp@latest ~/myproject-feature
...
```bash
npx -y @arimakouyou/spec-workflow-mcp@latest ~/myproject-feature --no-shared-worktree-specs
