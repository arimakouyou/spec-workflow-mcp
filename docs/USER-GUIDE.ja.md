...
1. **仕様を作成** - 構築したいものを定義
2. **要件をレビュー** - 仕様が要件を満たすことを確認
3. **要件を承認** - 要件ドキュメントを承認
4. **設計を作成** - 技術的アプローチを設計
5. **設計を承認** - 設計ドキュメントを承認
6. **テスト設計を作成** - テスト戦略、テストケース、受け入れ基準を定義
7. **テスト設計を承認** - テスト設計ドキュメントを承認
8. **タスクを作成** - 実装を実行可能なタスクに分解
9. **タスクを実装** - 実装計画を実行
10. **進捗を追跡** - 完了ステータスを監視
